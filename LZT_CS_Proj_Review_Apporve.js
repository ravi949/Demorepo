 ...
 */
define(['N/search', 'N/ui/dialog', './Dialog_Library_File.js'],
    function(search, dialog, nsiInputDialog) {
        /**
        ...
        function onButtonClick(id, type, userId) {
          
           console.log(type);
			
            var options = {
                title: 'Comments',
                message: 'Please Enter your comments below:',
                buttons: [{
                    label: 'Approve',
                    value: 1
                }, {
